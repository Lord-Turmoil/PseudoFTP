...
class PagedList<TSource, TResult> : IPagedList<TResult>
{
    /// <summary>
        ...
        int pageIndex, int pageSize, int indexFrom)
    {
        ...
        if (source is IQueryable<TSource> querable)
        {
            ...
            TSource[] items = querable.Skip((PageIndex - IndexFrom) * PageSize).Take(PageSize).ToArray();
        ...
        else
        {
            ...
            TSource[] items = source.Skip((PageIndex - IndexFrom) * PageSize).Take(PageSize).ToArray();
